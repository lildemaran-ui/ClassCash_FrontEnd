...
import { 
  Home, Wallet, MessageSquare, Settings, 
  HelpCircle, ArrowLeft, Eye, EyeOff, Bell, Grid 
} from 'lucide-react';
...
const ReclamacaoCard = ({ titulo, remetente, assunto, data, status, isPublica }: ReclamacaoProps) => (
  <div className="bg-white p-6 rounded-sm shadow-sm mb-4 relative border border-gray-100">
    ...
    <div className="space-y-1">
      <p className="text-xs text-gray-500"><span className="font-medium">Remetente:</span> {remetente}</p>
      <p className="text-xs text-gray-500"><span className="font-medium">Assunto:</span> {assunto}</p>
      <p className="text-xs text-gray-500 mt-4"><span className="font-medium">Solicitação:</span> {status}</p>
    </div>
      ...
      <aside className="w-64 bg-[#268cff] flex flex-col py-8 fixed h-full">
        <div className="flex flex-col items-center mb-10 px-6">
          <div className="bg-white p-3 rounded-2xl mb-2">
            <div className="w-10 h-10 bg-[#268cff] rounded-lg flex items-center justify-center text-white font-bold text-xl">$</div>
          </div>
        ...
        <nav className="flex flex-col gap-1">
          ...
          <SidebarItem icon={MessageSquare} label="Reclamações" active />
      ...
      <main className="flex-1 ml-64 p-10">
        ...
        <header className="flex justify-between items-center mb-8">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="w-10 h-10 rounded-full overflow-hidden border-2 border-white shadow-sm">
              <img src="https://via.placeholder.com/40" alt="Perfil" className="object-cover" />
            </div>
          </div>
        </header>
        ...
        <div className="max-w-4xl mx-auto text-center mb-10">
          <p className="text-gray-800 font-bold text-[13px] leading-relaxed">
            As suas reclamações podem ser anónimas ou públicas. Basta deixar o ícone do olho na lateral direita aberto,<br />
        ...
        <div className="max-w-5xl mx-auto flex gap-8 items-start">
          <div className="w-1/4">
            <p className="text-gray-800 font-bold text-sm">Tem uma reclamação a fazer?</p>
          ...
          <div className="flex-1 bg-white p-6 rounded-lg shadow-sm relative">
            <div className="space-y-4 mb-12">
              <div className="flex items-center gap-2 border-b border-gray-50 pb-2">
                ...
                <input type="text" className="flex-1 outline-none text-sm text-gray-800" />
              </div>
              <div className="flex items-center gap-2 border-b border-gray-50 pb-2">

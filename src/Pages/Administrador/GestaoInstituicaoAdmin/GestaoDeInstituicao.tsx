...
export default function GestaoDeInstituicao() {
  const { institutions, addInstitution, recarregar, newlyAddedId } =
    useInstitutions();
          ...
          <div className="bg-white p-6 rounded-xl border border-gray-200">
            <div className="flex justify-end space-x-3 mb-6">
              <button
                ...
                className="flex items-center bg-[#184d8a] text-white text-sm font-medium py-2 px-4 rounded-lg hover:bg-[#184d8a]/80 transition-colors shadow-md"
              >

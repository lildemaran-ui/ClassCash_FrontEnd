        ...
        <section className="mb-8">
          <div className="flex justify-start items-center ">
            <div className="flex gap-4 ">
              {["Mês", "Forma de pagamento", "Serviço", "Estado", "Classe"].map(
                (filtro) => (
                  <div key={filtro}>
           ...
           <div className="flex justify-center items-center  mt-3 border hover:border-[#268cff] hover:bg-white px-4 py-2 rounded-lg w-52 hover:text-[#268cff] text-white font-medium shadow-sm bg-[#268cff] transition-all duration-500 hover:mr-2 ml-auto cursor-default ">
          Adicionar Pagamento
        </div>

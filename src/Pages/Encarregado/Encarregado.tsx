      ...
      <main className="flex-1 overflow-y-auto min-w-0 px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
        ...
        <div className="flex justify-end mb-4">
          <button
            ...
            className="text-[#268cff] text-sm sm:text-base font-medium flex items-center gap-2 transition-all duration-500"
          >
        ...
        <header className="flex flex-col sm:flex-row sm:justify-between sm:items-start gap-6 mb-8">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start gap-4 sm:gap-6">
            ...
            <div className="space-y-1 text-center sm:text-left">
              ...
              <p className="text-sm text-gray-600"><strong>Nome do seu Educando:</strong> {user.nomeEstudante}</p>
              <p className="text-sm text-gray-600"><strong>Relação Parental:</strong> {user.relacao}</p>
          ...
          <div className="bg-white p-5 rounded-xl border w-full sm:min-w-[250px] sm:w-auto flex items-center gap-4">
            ...
            <div className="flex flex-col">
              ...
              <p className="text-green-600 text-sm font-medium">Financeiramente está estável</p>
        ...
        <div className="mt-6 flex justify-center sm:justify-end">
          <button className="bg-[#268cff] text-white px-6 py-2 rounded-lg flex items-center gap-2 hover:bg-blue-600 transition-all duration-500 w-full sm:w-auto justify-center">

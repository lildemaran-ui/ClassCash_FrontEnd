import { ArrowDown, EyeIcon, PiIcon } from "lucide-react";
import {
  LayoutDashboard,
  Users,
  CreditCard,
        ...
        <aside className="w-64 bg-[#268cff] flex flex-col sticky top-0 h-screen">
          ...
          <nav className="flex-1 flex flex-col gap-1 text-white">
            ...
            <Link to="/GestaoPropinas">
              ...
              <SidebarItem icon={<Receipt></Receipt>} label="Gestão de Pagamentos" active={false} />
            </Link>
            <SidebarItem
          ...
          <div className="flex justify-start mb-6">
            <div className="relative w-96">
              ...
              <input
                ...
                className="w-80 pl-10 pr-5  py-2 rounded-xl border border-gray-200 focus:outline-none focus:ring-2 focus:ring-MeuAzul/20 focus:border-none"
              />
            </div>
          </div>
        </section>

...
import { CreditCard, Receipt, Settings, MessageSquare, AlertOctagon, FileText, ScrollText,KeyIcon,School,InfoIcon,Search,Bell,CircleUser,Menu, Users, LayoutDashboard, Plus,Minus, Building2, UploadCloud, ArrowUp, ArrowDown, CheckCircle, XCircle, Calendar, Phone, Mail, ChevronDown, X } from "lucide-react";
...
const AddInstitutionModal: React.FC<{ onClose: () => void }> = ({
  onClose,
}) => {

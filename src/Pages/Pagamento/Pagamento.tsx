      ...
      {(pagamento.metodo === "De forma digital" || pagamento.metodo === "No banco") && (
        <div className="flex flex-col gap-6 animate-in fade-in">
          ...
          <div className="bg-blue-50 p-5 rounded-xl border border-blue-100 shadow-sm">
            ...
            <div className="text-3xl font-black text-blue-700">KZ {valorTotal.toLocaleString("pt-PT")},00</div>
          ...
          <button
            ...
            className={`py-4 rounded-xl font-bold text-lg transition-all transform active:scale-95 shadow-lg ${
              formularioValido ? "bg-[#268cff] text-white hover:bg-blue-600" : "bg-gray-200 text-gray-400 cursor-not-allowed shadow-none"
            }`}
          >
            Enviar Pagamento
          </button>

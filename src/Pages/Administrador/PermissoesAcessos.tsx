...
const UTILIZADORES_MOCK: Utilizador[] = [
  ...
  },
  {
    id: 2,
    nome: "João Baptista",
    email: "joao@kibangas.ao",
    perfil: "Admin Local",
    instituicao: "Kibangas",
    status: "Ativo",
    planoActivo: true,
  ...
  },
  {
    id: 3,
    nome: "Maria Filomena",
    email: "maria@caracol.ao",
    perfil: "Admin Local",
    instituicao: "Colégio Caracol",
    status: "Ativo",
    planoActivo: false,
    ultimoAcesso: "Ontem, 09:15",
  },
  {
    id: 4,
    nome: "Pedro Santos",
    email: "pedro@maptess.ao",
    perfil: "Secretaria",
    instituicao: "MAPTESS",
    status: "Ativo",
    planoActivo: true,
  ...
  },
  {
    ...
    status: "Inativo",
    planoActivo: false,
    ultimoAcesso: "15/11/2025",
  },
  {
    id: 6,
    nome: "Carlos Mendes",
    email: "carlos@insutec.ao",
    perfil: "Admin Local",
    instituicao: "INSUTEC",
    status: "Ativo",
    planoActivo: true,
  ...
  },
  {
    id: 7,
    nome: "Sofia Lopes",
    email: "sofia@elizangela.ao",
    perfil: "Secretaria",
    instituicao: "Elizângela F.",
    status: "Bloqueado",
    planoActivo: false,
    ultimoAcesso: "20/10/2025",
  },
];
    ...
    >
      <div className="bg-white rounded-2xl shadow-2xl w-full max-w-md">
        ...
        <div className="flex justify-end gap-3 p-6 bg-gray-50 border-t rounded-b-2xl">
          <button
            onClick={onClose}
            className="text-gray-600 text-sm font-medium py-2 px-5 rounded-lg hover:bg-gray-200 transition-colors"
          >
            Cancelar
          </button>
...
export default function PermissoesAcessos() {
  const [utilizadores, setUtilizadores] =
    useState<Utilizador[]>(UTILIZADORES_MOCK);
        ...
        <main className="p-6 md:p-8 space-y-6">
          ...
          <div className="flex flex-wrap items-center justify-between gap-3">
            ...
            <div className="flex gap-2 flex-wrap">
              {(
                ["Todos", "Super Admin", "Admin Local", "Secretaria"] as const
              ).map((p) => (
                <button
                  key={p}
                  onClick={() => setFiltro(p)}
                  ...
                  {filtered.map((u) => {
                    ...
                    return (
                      ...
                      >
                        ...
                        <td className="px-6 py-3">
                          <span
                            className={`inline-flex items-center gap-1 text-xs font-semibold px-2.5 py-1 rounded-full ${BADGE[u.perfil].cor}`}
                          >
                        ...
                        <td className="px-6 py-3 text-center">
                          <span
                            className={`inline-flex items-center gap-1 text-xs font-semibold px-2.5 py-1 rounded-full ${STATUS_COR[u.status]}`}
                          >
                            {u.status}
                          </span>
                        </td>
                        ...
                        <td className="px-6 py-3 text-center">
                          <button
                            ...
                            title={
                              u.status === "Ativo" ? "Desactivar" : "Activar"
                            }
            ...
            <div className="flex items-start gap-3 mb-5">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500 mt-0.5">
                  ...
                  plano activo para acesso. Quando o plano está inactivo, a
                  secretaria vê a aba bloqueada.
                </p>
              </div>
            </div>

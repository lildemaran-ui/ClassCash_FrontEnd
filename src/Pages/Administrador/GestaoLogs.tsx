      ...
      <main className=" flex flex-1 flex-col">
        ...
        <div className="flex space-x-4 mb-6 p-6">
          <div className="relative">
            <select className="appearance-none block w-full bg-white border border-gray-300 rounded-lg py-2 pl-3 pr-8 text-sm focus:outline-none focus:ring-[#184d8a] focus:border-[#184d8a]" defaultValue="Todos os Níveis">
          ...
          <div className="relative">
            <input type="date" className="block w-full bg-white border border-gray-300 rounded-lg py-2 pl-3 pr-3 text-sm focus:outline-none focus:ring-[#184d8a] focus:border-[#184d8a] text-gray-700" />
          </div>
        </div>
            ...
            <thead className="bg-[#184d8a]/70">
              <tr>
                {["Data/Hora", "Nível", "Utilizador", "Ação", "Detalhes"].map((header) => (
                  <th key={header} scope="col" className="px-6 py-3 text-center text-sm font-bold text-white tracking-widest cursor-default">
                    {header}
                  </th>
                ))}
              </tr>

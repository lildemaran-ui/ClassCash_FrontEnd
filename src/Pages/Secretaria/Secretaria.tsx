      ...
      <div className="min-w-[400px]">
        <div className="flex items-end h-48 sm:h-64 border-l border-b border-gray-300 relative">
          {[0, 20, 40, 60, 80, 100].map((y) => (
            <div key={y} className="absolute left-0 w-full text-xs sm:text-sm text-gray-500"
          ...
          {values.map((value, index) => (
            <div key={index} className="flex flex-col items-center h-full justify-end relative z-10"
              ...
              <div
                className="w-6 sm:w-10 bg-[#268CFF] hover:bg-blue-500 transition-all duration-300 rounded-t-md"
                style={{ height: `${value}%` }}
        ...
        <div className="px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          ...
          <section className="mb-6 sm:mb-8">
            <div className="flex flex-col sm:flex-row sm:justify-between sm:items-end gap-4 mb-6">
              ...
              <button className="flex items-center justify-center gap-2 px-4 py-2 bg-[#268cff] text-white rounded-md text-sm font-semibold hover:bg-blue-500 transition-all duration-500 w-full sm:w-auto">
            ...
            <div className="grid grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
              <CardKpi title="Total de estudantes" value="50" subtext="no último mês" trend="up" />
              <CardKpi title="Total de Encarregados" value="100" subtext="no último mês" trend="up" />
              <CardKpi title="Estudantes ativos" value="50" subtext="no último mês" />
              <CardKpi title="Estudantes Inativos" value="0" subtext="no último mês" trend="down" />
            </div>
          </section>
          ...
          <section className="mb-6 sm:mb-8">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 sm:gap-6">
              {["Multicaixa Express", "Unitel Money", "PayPay"].map((servico) => (
                <div key={servico} className="bg-white p-4 sm:p-6 rounded-xl border text-center">
                  <p className="font-bold text-gray-700 mb-3 text-sm sm:text-base">{servico}</p>
                  <div className="h-2 w-4 bg-[#268cff] rounded-full mb-2 mx-auto"></div>
                  <p className="text-xs sm:text-sm text-gray-400">Serviço digital</p>
                </div>
              ))}
            </div>
          </section>
          ...
          <section className="mb-6 sm:mb-8">
            ...
            <div className="flex flex-col gap-1 border font-medium rounded overflow-hidden">
              {[
                ...
                <div key={i} className={`p-3 sm:p-4 ${i % 2 === 0 ? "bg-[#268bffd3] text-white" : "bg-white text-gray-700"}`}>
            ...
            <Link to="/GestaoAlunos">
              <button className="mt-4 bg-[#268cff] text-white px-6 py-2 rounded text-sm hover:px-7 transition-all duration-500 font-bold shadow-md">
                Ver mais
              </button>
            </Link>
          </section>
          ...
          <section className="bg-white p-4 sm:p-6 rounded-xl border mb-8">
            <div className="flex flex-col sm:flex-row sm:justify-between gap-4 mb-6 border-b pb-4">
              <div>
                ...
                <p className="text-[#268cff] font-bold text-sm sm:text-base">375.600,00 Kz</p>
              </div>
              <div className="text-center">
                <p className="text-xs sm:text-sm text-gray-500">Mês</p>
                <p className="text-blue-900 font-bold text-sm sm:text-base">Outubro</p>
              </div>
              <div>
                <p className="text-xs sm:text-sm text-gray-500">Faturamento anual</p>
                <p className="text-[#268cff] font-bold text-sm sm:text-base">4.507.200,00 Kz</p>
              </div>
            </div>

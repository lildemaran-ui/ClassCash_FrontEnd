...
export default function Encarregado() {
          ...
          <header className="flex flex-col lg:flex-row lg:items-end justify-between gap-6 mb-10">
            <div className="flex flex-col sm:flex-row items-center gap-6">
              <div className="relative group">
                <div className="w-32 h-32 lg:w-40 lg:h-40 rounded-full overflow-hidden border-2 text-white shadow-xl bg-primary transition-transform group-hover:scale-[1.02]">
                  {user.foto ? (
                    <img
                      src={user.foto}
                      alt={user.nome}
              ...
              <div className="text-center sm:text-left">
                ...
                <div className="flex flex-col justify-center sm:justify-start gap-x-4 gap-y-1 mt-2 text-gray-500 text-sm">
                  ...
                  <p>
                    <strong>Nome do Educando:</strong>{" "}
                    {user.nomeEstudante ?? "—"}
                  </p>
                </div>
              </div>
  ...
  {/* Botão exportar — fora do pdfRef para não aparecer no PDF */}

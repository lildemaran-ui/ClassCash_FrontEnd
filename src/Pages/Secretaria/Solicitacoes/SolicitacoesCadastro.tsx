            ...
            <div className="space-y-3">
              <div className="grid grid-cols-2 gap-3">
                {[
                  ...
                  ["Tipo",        item.tipo === "estudante" ? "Estudante" : "Encarregado"],
              ...
              <div className="bg-amber-50 border border-amber-200 rounded-xl p-3 flex items-start gap-2">
                ...
                <p className="text-xs text-amber-700">
                  A senha <strong>não é visível</strong> por segurança. Apenas os dados de identificação são mostrados.
                </p>
              </div>
            </div>
          )}
          ...
          {tab === "aprovar" && (
            <div className="space-y-4">
              <div className="bg-green-50 border border-green-200 rounded-xl p-4 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-green-700 mt-1">
                    Ao aprovar, será gerado um código único para este utilizador e um email de confirmação será enviado automaticamente.
                  </p>
                </div>
              </div>
              ...
              <div>
                ...
                <p className="text-xs text-gray-400 mt-1">Se deixar vazio, o sistema gera um código único automaticamente.</p>
              </div>
              ...
              <div className="bg-red-50 border border-red-200 rounded-xl p-4 flex items-start gap-3">
                ...
                <div>
                  ...
                  <p className="text-xs text-red-700 mt-1">
                    O utilizador receberá um email a informar que o cadastro não foi aprovado com o motivo indicado.
                  </p>
                </div>
              </div>

              <div>
                <label className="block text-sm font-medium text-gray-700 mb-1">Motivo da recusa <span className="text-red-500">*</span></label>
      ...
      <div className="flex flex-col flex-1 min-w-0">
        ...
        <div className="flex items-center justify-between p-6 sticky top-0 z-40 bg-white/80 backdrop-blur border-b border-gray-100">
          <div className="flex items-center gap-3">
            <h1 className="text-xl font-bold text-[#268cff]">Solicitações de Cadastro</h1>
